...
import type { AnnouncementAudience, AnnouncementKind } from "@/types";
...
export default function NovaNovidadePage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-gray-900">Nova novidade / campanha</h1>
      ...
      <form onSubmit={submit} className="space-y-4 rounded-2xl border bg-white p-6 shadow-sm">
        <Field label="Título">
          <input
            ...
            placeholder="Ex.: Novidades no relatório e no perfil"
          />
        </Field>
        <Field label="Texto">
          <textarea
            ...
            placeholder="Conte o benefício de forma carinhosa e clara…"
          />
        </Field>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Field label="Link do botão (opcional)">
            <input
              ...
              className={inputClass}
              placeholder="/perfil ou /relatorio"
            />
          </Field>
        </div>
